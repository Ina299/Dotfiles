;; Path: icspub!wnoc-kyo!sh.wide!sun-barr!cs.utexas.edu!sdd.hp.com!zaphod.mps.ohio-state.edu!howland.reston.ans.net!agate!doc.ic.ac.uk!pipex!pavo.csi.cam.ac.uk!camcus!nj104
;; From: nj104_AT_cus.cam.ac.uk (Neil Jerram)
;; Newsgroups: gnu.emacs.sources
;; Subject: qwerty.el: supports Dvorak keyboard layout + generalised
;; Message-ID: <NJ104.93Mar1125218@bootes.cus.cam.ac.uk>
;; Date: 1 Mar 93 12:52:21 GMT
;; Sender: news_AT_infodev.cam.ac.uk (USENET news)
;; Distribution: gnu
...
;;;                "qwertyuiop@asdfghjkl;:zxcvbnm,./QWERTYUIOP`ASDFGHJKL+*ZXCVBNM<>?"))
  (anti-qwerty "1234567890',.pyfgcrl/aoeuidhtns-;qjkxbmwvz`!@#$%^&*()\"<>PYFGCRL?AOEUIDHTNS_:QJKXBMWVZ~"
               "1234567890qwertyuiop@asdfghjkl;:zxcvbnm,./\\!\"#$%&'()~QWERTYUIOP`ASDFGHJKL+*ZXCVBNM<>?_"))
